...
Ниже перечислены блоки, доступные для использования в Minecraft: Bedrock Edition.

> Примечание
> 
> Чтобы узнать больше о том, как функционируют блоки в Minecraft: Bedrock Edition, пожалуйста, ознакомьтесь с документацией [Главная страница Документации по Блокам](../../Block_JSON/README.md)

## Состояния блоков

| Название состояния блока | Тип     | Допустимые значения | Описание                                |
|--------------------------|---------|---------------------|-----------------------------------------|
| age_bit                  | Boolean | True, False         | Определяет, должны ли саженцы расти     |
| age                      | Integer | 0 - 15              | Представляет возраст блока              |
| portal_axis              | String  | unknown, x, z       | Определяет ориентацию портальных блоков |
