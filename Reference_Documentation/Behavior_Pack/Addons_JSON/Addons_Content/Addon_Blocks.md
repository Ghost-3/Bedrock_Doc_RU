...
> Примечание
> 
> Чтобы узнать больше о том, как функционируют блоки в Minecraft: Bedrock Edition, пожалуйста, ознакомьтесь с [JSON Документацией по Блокам](../../Block_JSON/README.md)
